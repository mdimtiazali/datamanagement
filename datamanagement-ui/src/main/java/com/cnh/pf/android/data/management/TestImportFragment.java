 ...
 */
public class TestImportFragment extends RoboFragment implements Mediator.ProgressListener {
   private static final Logger logger = LoggerFactory.getLogger(TestImportFragment.class);
   ...
   private class ConnectTask extends AsyncTask<Void, Void, Void> {
      ...
      protected Void doInBackground(Void... params) {
         try {
            ...
            mediator.setProgressListener(TestImportFragment.this);
            mediator.start();
         }
         catch (Exception e) {
            logger.error("", e);
