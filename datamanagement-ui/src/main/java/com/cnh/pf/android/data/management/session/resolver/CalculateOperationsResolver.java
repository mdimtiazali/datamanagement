...
/**
 * Resolve session property data for CALCULATE_OPERATIONS task.
 *
 * @author: junsu.shin@cnhind.com
 */
public class CalculateOperationsResolver implements Resolver {
   private static final Logger logger = LoggerFactory.getLogger(CalculateOperationsResolver.class);
   private final DatasourceHelper dsHelper;

   public CalculateOperationsResolver(final DatasourceHelper dsHelper) {
