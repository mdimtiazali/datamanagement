...
/**
 * Test Class for VarietyByCropTypeComparator.
 *
 * @author: Aakanksha Supekar
 */

@RunWith(RobolectricMavenTestRunner.class) @Config(manifest = "src/main/AndroidManifest.xml", application = TestApp.class) public class VarietyByCropTypeComparatorTest {

   private VarietyByCropTypeComparator varietyByCropTypeComparator;
   ...
   @Before public void setUp() throws Exception {
      ...
      varietyByCropTypeComparator = new VarietyByCropTypeComparator(activity);
   ...
   @Test public void testEqual() {
      ...
      int result = varietyByCropTypeComparator.compare(varietyOne, varietyTwo);
   ...
   @Test public void testGreaterThan() {
      ...
      varietyOne.setCropType(CropType.CORN);
      varietyTwo.setCropType(CropType.SOYBEAN);
   ...
   @Test public void testLessThan() {
      ...
      varietyOne.setCropType(CropType.SOYBEAN);
      varietyTwo.setCropType(CropType.CORN);
