...
/**
 * Test Class for ProductMixDefaultRateSortComparator.
 *
 * @author: Aakanksha Supekar
 */

@RunWith(RobolectricMavenTestRunner.class) @Config(manifest = "src/main/AndroidManifest.xml", application = TestApp.class) public class ProductMixDefaultRateSortComparatorTest {

   private ProductMixDefaultRateSortComparator productMixDefaultRateSortComparator;
   ...
   @Before public void setUp() throws Exception {
      ...
      productMixDefaultRateSortComparator = new ProductMixDefaultRateSortComparator(activity);
   ...
   @Test public void testEqual() {
      ...
      int result = productMixDefaultRateSortComparator.compare(productMixOne, productMixTwo);
