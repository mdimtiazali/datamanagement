...
public class MaximizedListViewTest {

   private MaximizedListView mMaximizedListView;
   ...
   @Test public void constructorTest() {
      mMaximizedListView = new MaximizedListView(RuntimeEnvironment.application, null);
      assertNotNull(mMaximizedListView);
   }

   @After public void tearDown() throws Exception {
      mMaximizedListView = null;
      assertNull(mMaximizedListView);
   }
